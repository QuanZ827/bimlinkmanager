...
pushd "%~dp0"
wix build "%~dp0BimLinkManager.wxs" -o "%~dp0Output\BimLinkManager_Setup_v1.0.10.msi" -arch x64
...
echo.
echo ==========================================
echo   SUCCESS! MSI: Installer\Output\BimLinkManager_Setup_v1.0.10.msi
echo ==========================================
